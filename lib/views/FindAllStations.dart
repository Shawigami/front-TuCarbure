      ...
      child: Scaffold(
        ...
        child : ListView.builder(
          ...
          return Card( // Nouveau widget Card
              ...
              children: [
              Text(stations[index].brand.name, style: TextStyle(color: Color(0xFF001931)))
            ],
            ),
                subtitle: RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(text: '${stations[index].statement.dateTimeStatement}\n', style: TextStyle(color: Color(0xFF001931))),
                      TextSpan(text: 'Prix actuel: ', style: TextStyle(color: Color(0xFFEF7300))),
                      TextSpan(text: '${stations[index].statement.price} €', style: TextStyle(color: Color(0xFF001931))),
                    ],
                  ),
                ),
                onTap: () {
